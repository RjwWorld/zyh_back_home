<template>
  <el-dialog title="项目查看" :visible.sync="showDialog" @close="closeFuc" width="1200px" center>
    <div class="newslistDetails">
      <el-form label-width="100px" label-position="right" style="padding-left:350px;">
        <div class="form_div">
        ...
        <div class="form_div">
          <el-form-item label="项目分类：">
            <span>{{dataObj.projectClassification}}</span>
          </el-form-item>
        </div>
        <div class="form_div">
        ...
        <div class="form_div1">
          <el-form-item label="图片：" v-if="dataObj.coverImgUrl">
            <look-img :imgUrl ="dataObj.coverImgUrl"/>
          </el-form-item>
        </div>
        <div class="form_div">
