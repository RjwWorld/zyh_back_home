    ...
    <div class="uploadImg">
        ...
        <div class="initImg" v-if="header">
            <div class="inputFileHeader">
                ...
                <input class="upload_file" type="file" @change="changeFuc" accept="image/jpeg,image/jpg,image/png,image/svg">
            </div>
        </div>
        <!-- 显示单张图片 -->
        ...
        <div class="initImg" v-if="more && !header">
            <div class="imgListBox" v-if="imgList.length>0">
                <div class="imgBox" v-for="(item,index) in imgList" :key="index">
                    ...
                    <span class="look_del" @mouseenter="$event.target.style.opacity='1'" @mouseleave="$event.target.style.opacity='0'" style="opacity:0">
