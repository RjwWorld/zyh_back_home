<template>
  ...
  <div class="projectDialog">
    <el-dialog
      ...
      center
    >
      <industrial-park-details :dataObj="dataObj" :freeDataObj="freeDataObj"/>
...
<script>
  import industrialParkDetails from '@/components/industrialPark/industrialParkDetails'
  import {insertPark} from "@/api"
  export default {
    components:{
      industrialParkDetails
    },
    props:{
