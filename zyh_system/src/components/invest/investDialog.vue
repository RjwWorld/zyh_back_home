...
<script>
import investDetails from '@/components/Project/dialog/investDetails'
import {insertCapitalSide} from "@/api"
export default {
    components:{
        investDetails
    },
    ...
    methods:{
        ...
        submitFuc(){
          ...
          // this.auditObj.homeRecommend=0
        },
        // subFuc() {
        //     insertCapitalSide(this.dataObj)
        //         .then(res => {
        ...
        //             type: "success"
        //             });
        //           console.log(this.resetForm('projectForm'))
        //         }
