                    ...
                    <div class="must_div">
                        ...
                        <div class="form_div1">
                            <el-form-item label="摘要：" prop="digest">
                                <el-input v-model="dataObj.digest" type="text" placeholder="不得多余20个字符" maxlength="20"></el-input>
                            </el-form-item>
                        </div>
                        <div class="like_div">
                                ...
                                <el-form-item label="成交价：" prop="startAmt" label-width="88px">
                                    <div class="form_divM">
                                        <span class="spanInput">
                                            <el-input :disabled="checkedM" v-model="dataObj.startAmt" type="text" placeholder="成交价" maxlength="10">
                            ...
                            <div>
                                ...
                                <div class="children_div">
                                    <el-form-item label="容积率：" prop="volumeRate">
                                        <span class="spanInput">
                                            <el-input v-model="dataObj.volumeRate" type="text" placeholder="容积率">
                                            </el-input>
                                        </span>
                                    </el-form-item>
                                    <div>
                                        ...
                                        <div class="form_divH">
                                          <el-form-item prop="households">
                                            <span class="house_park">
                                                <el-input v-model="dataObj.households" type="text" placeholder="总户数" maxlength="5"></el-input>
                                            </span>
                                          </el-form-item>
                                          <span>&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                                          <el-form-item prop="parkingSpaces">
                                            <span class="house_park">
                                                <el-input v-model="dataObj.parkingSpaces" type="text" placeholder="车位总数" maxlength="5"></el-input>
                                            </span>
                                          </el-form-item>
                          ...
                          <div>
                            ...
                            <div>
                                <el-form-item label="土地位置：">
                                    <el-select v-model="provinceInfoLand" @change="changeProvince('land')" placeholder="请选择">
                                        <el-option
                            ...
                            <div>
                                ...
                                <div class="children_div">
                                    <el-form-item prop="devUncertainFactorsList" label-width="0">
                                        ...
                                        <el-form-item v-if="dataObj.devUncertainFactorsList && dataObj.devUncertainFactorsList.indexOf('F') > -1" label="其他：" prop="other" label-width="66px" size="mini">
                                            <span class="spanInput" style="width:333px">
                                                <el-input v-model="dataObj.other" type="text" placeholder="其他因素" ></el-input>
                                            </span>
                                        </el-form-item>
                                    </el-form-item>
                                </div>
...
export default {
    ...
    methods:{
        submitForm(projectForm) {
          ...
          }else if(this.dataObj.projectTypeCode===2000){
        ...
        editFuc(){
            this.$confirm('确定修改该项目?', '提示', {
                ...
                if(this.dataObj.projectTypeCode === 2000){
                  this.dataObj.other=this.dataObj.devUncertainFactorsList.indexOf('F') > -1 ? this.dataObj.other :'';
                  // if(this.households&&this.park){
                  //   this.dataObj.parkingRatio = `${this.households}:${this.park}`
                  // }
                  modifyProjectB(this.dataObj).then(res=>{
                    if(res && res.errorCode === 0){
                      this.showDialog = false
                      this.$emit('changeFuc')
                      this.$message({
